...
class QWaylandInputMethodEventBuilder {
	...
	void setDeleteSurroundingText(uint32_t beforeLength,
	...
	static int indexFromWayland(const QString &text, int length,
				    int base = 0);
	static int indexToWayland(const QString &text, int length,
				  int base = 0);

	static int trimmedIndexFromWayland(const QString &text, int length,
					   int base = 0);
...
struct QWaylandInputMethodContentType {
	...
	static QWaylandInputMethodContentType
	convert(Qt::InputMethodHints hints);
	static QWaylandInputMethodContentType
	convertV3(Qt::InputMethodHints hints);
};
